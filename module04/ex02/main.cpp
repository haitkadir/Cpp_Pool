...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/22 15:13:25 by haitkadi          #+#    #+#             */
/*   Updated: 2022/11/22 15:13:26 by haitkadi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void){
    // Animal anim; // this give us an ERROR: variable type 'Animal' is an abstract class
